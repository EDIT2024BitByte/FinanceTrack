...
namespace Comtrade.FinanceTrack.SyncService.Dec.Init
{
    public static class InitializationComponent
    {
        public static ServiceProvider Initialize(IServiceCollection serviceProvider)
        {
            serviceProvider.AddTransient<IBudgetDecreaseConsumeService, BudgetDecreaseConsumeService>();
            ...
            serviceProvider.AddScoped<DbContext, BudgetContext>();
