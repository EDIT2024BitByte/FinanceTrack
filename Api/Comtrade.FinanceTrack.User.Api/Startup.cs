...
namespace Comtrade.FinanceTrack.User.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                settings.Title = "Comtrade.FinanceTrack.User.Api";
                settings.Version = "v1";
            ...
            services.AddAutoMapper(c => c.AddProfile<UserMappingProfile>(), typeof(Startup));
        }
